...
auth_grp = environ.get('AUTH_GROUP', '-1002132345615')
...
URL = "https://tgbotg-d7f0666ebacb.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
      "https://tgbotg-d7f0666ebacb.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tgbotg-d7f0666ebacb.herokuapp.com/".format(FQDN)
else:
    URL = "https://tgbotg-d7f0666ebacb.herokuapp.com/".format(FQDN)
